function WhyUS(){
    return(
        ...
        >
            ...
            We’re targeting fast-growing emerging markets like Kenya, where the
            appetite for sophisticated yet accessible financial products is surging. With
            an ambitious growth strategy, a differentiated vision, and a scalable
            revenue model, PAAB Capital is positioned to redefine wealth management
            for a new generation.
            We invite you to partner with us — not just to invest, but to shape the future
